    ...
    ui(new Ui::Dashboard)
{
    ...
    // ##############SIDE_NAVIGATION_BAR######################
    QIcon home("C:/Users/mehdi/QT_new_project/employee-management-system/home.png");
    ...
    QIcon salary("C:/Users/mehdi/QT_new_project/employee-management-system/salary.png");
    ...
    QIcon attendance("C:/Users/mehdi/QT_new_project/employee-management-system/attendance.png");
    ...
    QIcon performance("C:/Users/mehdi/QT_new_project/employee-management-system/performance.png");
    ...
    QIcon logout("C:/Users/mehdi/QT_new_project/employee-management-system/logout.png");
...
void Dashboard::on_leave_btn_clicked()
{
    ...
    db2.setDatabaseName("C:/Users/mehdi/QT_new_project/employee-management-system/EMS.db");
    if(db2.open()){
        QSqlQuery query(db2);
