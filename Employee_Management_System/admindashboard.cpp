    ...
    ui(new Ui::AdminDashboard)
{
    ...
    db.setDatabaseName("C:/Users/mehdi/QT_new_project/employee-management-system/EMS.db");
    if (db.open()){
        QSqlQuery query1(db);
           query1.prepare("SELECT COUNT(*) FROM Employee;");
            ...
            if (query1.next()) {
               ...
               /* while (query2.next()) {
                    ...
                    ui->id_listwidget->setStyleSheet("QListWidget { border: none; color: black; }");
                    ui->name_listwidget->addItem(name);
                    ui->name_listwidget->setStyleSheet("QListWidget { border: none; color: black; }");
                    ui->department_listwidget->addItem(department);
                    ui->department_listwidget->setStyleSheet("QListWidget { border: none; color: black; }");
...
void AdminDashboard::refresh(){
    ...
    db4.setDatabaseName("C:/Users/mehdi/QT_new_project/employee-management-system/EMS.db");
    if(db4.open()){
